...
public class TokenTest extends DSUnitTesting{
	...
	public final void testEquals() {
		...
		Token t3 = new Token("Foo");
		Token t4 = new Token("Bar");
		...
		assertTrue("(Checking two equal tokens are equal: operator)", t3.equals(new Token("Foo")));
		assertTrue("(Checking two equal tokens are equal: operator)", t4.equals(new Token("Bar")));
	}
	...
	public final void testTokenFloat() {
		...
		assertEquals("Checking Token(int) sets operand correctly", t1.getOperand(), 0, 0.0001);
	}
